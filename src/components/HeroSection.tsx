...
// Simple hardcoded poems for hero section
...
export default function HeroSection() {
  ...
  useEffect(() => {
    // Ultra-simple approach - just use hardcoded poems for now
    const poems = [
      {
        id: 2133,
        title: 'غزل',
      ...
      },
      {
        id: 1126,
        title: 'غزل',
        verses: ['دل من و دل تو یکی است', 'در دو بدن یکی است'],
        poetId: 3,
        poetName: 'سعدی',
        categoryId: 31,
        categoryTitle: 'غزلیات',
      },
      {
        id: 2133,
        title: 'غزل',
        verses: ['اگر چه باده فرح بخش و باد گلبیز است', 'به بانگ چنگ مخور می که محتسب تیز است'],
        poetId: 2,
        poetName: 'حافظ',
        categoryId: 24,
        categoryTitle: 'غزلیات',
    ...
    // Simple timeout to show loading
