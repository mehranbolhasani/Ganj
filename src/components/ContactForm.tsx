    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            required
            aria-required="true"
            className="w-full rounded-lg border border-input dark:border-border bg-card px-3 py-2 outline-none focus:ring-2 focus:ring-yellow-500"
          />
        </div>
        <div>
      ...
      <div className="flex items-center justify-end">
        <button
          ...
          className="px-4 py-2 rounded-lg bg-accent text-primary-foreground dark:text-foreground hover:bg-primary dark:hover:bg-muted disabled:opacity-60"
        >
