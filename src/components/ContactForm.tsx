  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid md:grid-cols-2 gap-4">
        <div>
          <label htmlFor="contact-name" className="block text-sm text-stone-700 dark:text-stone-300 mb-1">نام</label>
          <input
            id="contact-name"
            type="text"
            value={name}
        ...
        <div>
          <label htmlFor="contact-email" className="block text-sm text-stone-700 dark:text-stone-300 mb-1">ایمیل</label>
          <input
            id="contact-email"
            type="email"
            value={email}
      ...
      <div>
        <label htmlFor="contact-message" className="block text-sm text-stone-700 dark:text-stone-300 mb-1">پیام</label>
        <textarea
          id="contact-message"
          value={message}
