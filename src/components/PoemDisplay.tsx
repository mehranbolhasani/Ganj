  ...
  return (
    <div className="max-w-4xl mx-auto w-full">
      <div className="text-center mb-8">
        <h1 className="font-doran text-4xl font-black text-stone-900 dark:text-stone-300 mb-4 text-right">
          {poem.title}
        </h1>
      ...
      <div className="bg-white/50 border border-white rounded-2xl shadow-lg/5 dark:bg-stone-800/50 dark:border-stone-700 p-8">
        <div className="prose prose-lg max-w-none text-center">
          {poem.verses.map((verse, index) => (
            <p 
              key={index}
              className="text-stone-900 dark:text-stone-300 leading-relaxed mb-4 text-lg text-right"
            >
              {verse}
            </p>
          ))}
