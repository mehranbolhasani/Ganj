...
export const FEATURED_POETS_FALLBACK: Poet[] = [
  { id: 2, name: 'حافظ', slug: 'hafez', birthYear: 726, deathYear: 792 },
  { id: 7, name: 'سعدی', slug: 'saadi', birthYear: 606, deathYear: 691 },
  { id: 5, name: 'مولوی', slug: 'moulavi', birthYear: 604, deathYear: 672 },
  { id: 4, name: 'فردوسی', slug: 'ferdousi', birthYear: 329, deathYear: 411 },
  { id: 9, name: 'عطار', slug: 'attar', birthYear: 513, deathYear: 618 },
